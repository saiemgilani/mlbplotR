...
A printable one-page reference for `mlbplotR` — the scales, geoms and gt
helpers — is available as a free PDF:

📄 **[Download the mlbplotR cheat sheet (PDF)](https://sportsdataverse.org/cheatsheets/mlbplotR.pdf)**

Light and dark, US Letter landscape. It sits alongside sheets for the other
SportsDataverse packages at
**[sportsdataverse.org/cheatsheets](https://sportsdataverse.org/cheatsheets)**.

## Citation

To cite the `mlbplotR` R package in publications, use:
...
`citation("mlbplotR")` returns this entry with the installed version number attached.
